...
public class Guest {
	// total number of guests ever registered
	private static int guestCount; //belongs to the class not to the guest (alma) belongs to all guests 
	...
	public Guest() {
		this( "default guest", new Room(), "xxx-xxx",0.0);
